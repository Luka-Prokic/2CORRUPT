...
interface SummaryCalendarBottomSheetProps {
...
export const SummaryCalendarBottomSheet = forwardRef<
  BottomSheetModal,
  SummaryCalendarBottomSheetProps
>(({ onDayPress, selectedDate }, ref) => {
